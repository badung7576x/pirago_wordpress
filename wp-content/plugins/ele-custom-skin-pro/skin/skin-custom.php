  ...
  $skin->add_control(
    ...
    $skin->add_control(
        ...
        'return_value' => '100%',
				'default' => 'auto',
				'selectors' => [
					'{{WRAPPER}} .ecs-link-wrapper, {{WRAPPER}} .ecs-custom-grid .ecs-post-loop, {{WRAPPER}} .ecs-post-loop .elementor, {{WRAPPER}} .ecs-post-loop .elementor .elementor-inner, {{WRAPPER}} .ecs-post-loop .elementor .elementor-inner .elementor-section-wrap, {{WRAPPER}} .ecs-post-loop .elementor .elementor-inner .elementor-section-wrap .elementor-top-section, {{WRAPPER}} .ecs-post-loop .elementor .elementor-container'
              => 'height: {{VALUE}} ',
