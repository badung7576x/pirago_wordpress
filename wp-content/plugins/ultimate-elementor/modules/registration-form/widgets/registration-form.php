		...
		if ( parent::is_internal_links() ) {
			$this->add_control(
				...
				array(
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( 'For other form fields shortcode click %1$s here %2$s.', 'uael' ), '<a href="https://uaelementor.com/docs/create-user-registration-form-using-only-email-field/#how-to-customize-user-email-in-the-user-registration-form-widget-" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				)
			);
		}
			...
			$this->start_controls_section(
				...
				$this->add_control(
					...
					array(
						'type'            => Controls_Manager::RAW_HTML,
						/* translators: %1$s doc link */
						'raw'             => sprintf( __( '%1$s Customize User Email » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/create-user-registration-form-using-only-email-field/#how-to-customize-user-email-in-the-user-registration-form-widget-" target="_blank" rel="noopener">', '</a>' ),
						'content_classes' => 'uael-editor-doc',
					)
				);
